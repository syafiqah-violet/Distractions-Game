...
public class AboutView extends StackPane {
    ...
    public AboutView(Runnable onPlay) {
        ...
        VBox card = new VBox(10,
                title,
                body("Four levels, each one asking for something different. A wrong drop and "
                        + "a top-out each cost a life; lose all three and the run ends."),
                ...
                body("Twelve grocery cards face down. Turn two over: a matching pair stays "
                        ...
                        + "pairs before the clock runs out. A mismatch costs points but no "
                        + "life — what it really costs is the seconds you spend on it."),
                heading("Scoring"),
                body("A correct drop or a matched pair pays 10, rising with your streak. A "
                        + "wrong drop costs 5 and a life; a mismatched pair costs 5 and your "
                        + "streak. Finishing a level early pays 2 per second left."),
                heading("Controls"),
